    ...
    return (
        ...
        <div className='w-[80%] mt-20'>
           ...
           <div className="grid grid-cols-12 lg:gap-5 mt-5">
            <div className=" col-span-12 lg:col-span-4 work-containers flex flex-col ">
            ...
            <div className=" col-span-12 lg:col-span-4 work-containers flex flex-col mt-5">
                <h2 className='text-white codec text-[20px]'><b>Front-end Developer</b> <b className='color-pink'>(Full-time)</b></h2>
